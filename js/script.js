...
function createNote(title,text){
    ...
    <div class="note-header">
      ...
      <input id="note-title-input"  class="note-title-input hidden" placeholder="${title}"></input>
    ...
    <textarea id="note-textarea" class="note-textarea hidden" placeholder="${text}"></textarea>
    `
...
addBtn.addEventListener('click', (e)=>{
  const el=createNote("Заголовок","Baш текст");
